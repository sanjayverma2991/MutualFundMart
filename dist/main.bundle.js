...
var CategoriesService = (function () {
    function CategoriesService(_http) {
        this._http = _http;
        this.img_colors = ["Black", "Red", "Indigo", "Green", "Orange", "Purple", "Brown", "Turquoise", "White", "Grey", "Lavender", "Yellow", "Pink", "Gold", "HDFC", "ICICI", "SBI", "AXIS"];
